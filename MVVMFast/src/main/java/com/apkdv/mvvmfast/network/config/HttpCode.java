package com.apkdv.mvvmfast.network.config;
...
public class HttpCode {
    ...
    public static class HTTP {
         ...
         * http 用户未登录
         */
        public static final int HTTP_UNLOGIN = 10002;

        /**
         * 找不到资源
         */
        public static final int NOT_RESOURCES = 10003;
    ...
    public static class FRAME_WORK {
        ...
        //  请求取消
        public static final int REQUEST_CANCEL = -1006;
    }
