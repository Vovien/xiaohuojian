...
public class StatusBarCompat {
     ...
     * @param statusColor
     */
    public static void StatusBarLightModeWithColor(Activity activity, @ColorInt int statusColor) {
        setStatusBarColor(activity, statusColor);
        statusBarLightMode(activity.getWindow());
    }
    ...
    public static boolean isFullScreen(Window window) {
        return (window.getDecorView().getSystemUiVisibility() & View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN) != 0;
    }
    ...
    public static boolean hasNavigationBar(Context var0) {
        ...
        try {
            Class var5;
            String var6 = (String) (var5 = Class.forName("android.os.SystemProperties")).getMethod("get", String.class).invoke(var5, new Object[]{"qemu.hw.mainkeys"});
            if ("1".equals(var6)) {
                var1 = false;
