...
public final class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    public static class Builder {
        ...
        public Builder color(int color, int strokeWidth) {
        ...
        public Builder leftMargin(int size) {
            this.leftMargin = size;
            return this;
        }

        public Builder rightMargin(int size) {
            this.rightMargin = size;
            return this;
        }

        public Builder topMargin(int size) {
            this.topMargin = size;
            return this;
        }

        public Builder bottomMargin(int size) {
            this.bottomMargin = size;
            return this;
        }
