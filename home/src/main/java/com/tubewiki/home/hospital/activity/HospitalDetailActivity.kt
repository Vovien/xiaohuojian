...
import com.tubewiki.home.databinding.ActivityHospitalDetailBinding
...
import com.tubewiki.home.hospital.adpater.HospitalImageAdapter
import com.tubewiki.home.hospital.adpater.HospitalLeaderAdapter
import com.tubewiki.home.hospital.adpater.HospitalTechAdapter
...
class HospitalDetailActivity :
    ...
    private var hospitalDetails: HospitalDetailBean? = null
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        if (HospitalConstant.lastActivity == null) {
...
//                    1 -> binding.scrollerLayout.scrollToChildWithOffset(binding.llTech, offset)
    ...
    private fun initListener() {
        ...
        binding.apply {
            ...
            binding.scrollerLayout.setOnVerticalScrollChangeListener { _, scrollY, _, _ ->
                var rate =
            ...
            hospitalLeaderAdapter.setOnItemClickListener { adapter, view, pos ->
                WikiRouter.toDoctorDetailsActivity(hospitalLeaderAdapter.getItem(pos).doctorId)
            }
                ...
                CustomListBottomDialog(this, reportListData) {
                    ...
                    if (it == 1 || it == 2) {
                        ARouter.getInstance().build("/middleware/activity/feed_error")
                            ...
                            .withString(
                                TagConstant.PARAMS2,
                                hospitalDetails?.hospital?.hospitalName
                            )
                            .navigation()
                    }
...
//        binding.commonTabLayout.scrollToCurrentTab()
    ...
    private fun loadViewData(hospitalDetailBean: HospitalDetailBean) {
        hospitalDetails = hospitalDetailBean
        binding?.apply {
            ...
            titleBarView.setRightView(com.jmbon.minitools.R.layout.layout_minitool_right)

            titleBarView.rightCustomView.findViewById<View>(com.jmbon.minitools.R.id.iv_more)
                .setOnClickListener {
            ...
            titleBarView.rightCustomView.findViewById<View>(com.jmbon.minitools.R.id.iv_close)
                .setOnClickListener {
            ...
            ivCover.onClick {
                val media = LocalMedia(hospitalDetailBean.hospital.logo, 0, 0, "")
                SelectPhotoUtils.externalPicturePreview(ActivityUtils.getTopActivity(), 0, arrayListOf(media) )
            }
