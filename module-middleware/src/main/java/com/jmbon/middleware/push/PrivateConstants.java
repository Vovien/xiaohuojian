...
public class PrivateConstants {
    ...
    public static final long HW_PUSH_BUZID = 17647;
    ...
    /****** 小米离线推送参数start ******/
    // 在腾讯云控制台上传第三方推送证书后分配的证书ID
    public static final long XM_PUSH_BUZID = 17646;
    ...
    /****** 魅族离线推送参数start ******/
    // 在腾讯云控制台上传第三方推送证书后分配的证书ID
    public static final long MZ_PUSH_BUZID = 17648;
    ...
    /****** vivo离线推送参数start ******/
    // 在腾讯云控制台上传第三方推送证书后分配的证书ID
    public static final long VIVO_PUSH_BUZID = 17649;
    ...
    /****** oppo离线推送参数start ******/
    // 在腾讯云控制台上传第三方推送证书后分配的证书ID
    public static final long OPPO_PUSH_BUZID = 17650;
    // oppo开放平台分配的应用APPID及APPKEY
    public static final String OPPO_PUSH_APPID = "";
    public static final String OPPO_PUSH_APPKEY = "8c28e849abab417f8f331f2eabf8f263";
    public static final String OPPO_PUSH_APPSECRET = "630d26a8644e4d9c8f04a6be89a86bd6";
    /****** oppo离线推送参数end ******/
