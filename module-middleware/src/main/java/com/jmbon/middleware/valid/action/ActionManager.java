package com.jmbon.middleware.valid.action;


import com.jmbon.middleware.valid.annotation.Interceptor;
import com.jmbon.middleware.valid.exp.ValidException;
    ...
    public void checkValid() {
        ...
        if (delaysActions.size() > 0) {
            ...
            if (!callUnit.getLastValid().check()) {
                throw new ValidException(String.format("you must pass through the %s,and then reCall()", callUnit.getLastValid().getClass()));
            }
