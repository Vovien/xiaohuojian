...
//        mTextSize = typedArray.getDimensionPixelSize(R.styleable.SideIndexBar_cpIndexBarTextSize, SizeUtils.sp2px(12));
        mTextSize = SizeUtils.sp2px(12);

//        mTextColor = typedArray.getColor(R.styleable.SideIndexBar_cpIndexBarNormalTextColor, 0xFF000000);
        mTextColor = ColorUtils.getColor(R.color.text_color);
        mTextTouchedColor =mTextColor;
//        mTextTouchedColor = typedArray.getColor(R.styleable.SideIndexBar_cpIndexBarSelectedTextColor, 0xFF000000);
        typedArray.recycle();
