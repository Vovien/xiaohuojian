package com.jmbon.minitools.pregnancy.adapter
...
import com.jmbon.minitools.databinding.ItemPregnancyHelpGroupLayoutBinding
import com.jmbon.minitools.pregnancy.bean.RecommendCircle
import kotlin.math.min

class PregnancyHelpGroupAdapter :
    ...
    override fun convert(holder: BaseBindingHolder, item: RecommendCircle) {
        holder.getViewBinding<ItemPregnancyHelpGroupLayoutBinding>().apply {
            ...
            holder.setGone(
                R.id.gp_member,
                item.memberAvatar.isNullOrEmpty() && item.txt.isNullOrBlank()
            )
