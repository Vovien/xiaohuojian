package com.jmbon.video.widget.thumbnail;
...
public class ThumbnailView extends LinearLayout {
    ...
    private void init() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.layout_view_thumbnail, this, true);
        findAllViews();

    }

    private void findAllViews() {
        mPositionTextView = findViewById(R.id.textPosition);
        mThumbnailImageView = findViewById(R.id.imageThumbnail);
    }
