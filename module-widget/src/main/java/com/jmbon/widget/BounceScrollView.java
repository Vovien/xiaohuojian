...
public class BounceScrollView extends ScrollView {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isNeedMove()) {
                    ...
                    Log.d("TAG", "inner.getMeasuredHeight():" + inner.getMeasuredHeight() + ", getHeight: " + getHeight() + ", getScrollY():" + getScrollY());
                    ...
                    if (scrollY == 0) {
                        ...
                        if (inner.getTop() - deltaY > 0) {
                            isPull = true;
                            onPullListener.pullUp(inner.getTop() - deltaY, -deltaY);

                            int off = (inner.getTop() - deltaY);
                            Log.d("TAG", inner.getTop() + ",commOnTouchEvent pullUp: " + off);
                        }
                    }
                    if (scrollY == offset) {
                        if (inner.getTop() - deltaY < 0) {
    ...
    private void hide() {
        ...
        Log.d("txy", "last hide：" + tempDown + "," + tempUp);

        timer.schedule(5);
    }

    public interface OnPullListener {
        void pullUp(int dif_y, int y);
        ...
        void downRelease(float y, boolean isLast);

        void upRelease(float y);
    }
        ...
        public void handleMessage(Message msg) {
            if (null != inner) {
                ...
                if (tempDown > 0) {
                    ...
                    tempDown -= speed;
                    if (tempDown < 0) {
                        onPullListener.downRelease(tempDown, true);
                    } else {
                        onPullListener.downRelease(-speed, false);
                    }
                ...
                if (tempUp > 0) {
                    ...
                    onPullListener.upRelease(-tempUp);
                }
            }
        }
