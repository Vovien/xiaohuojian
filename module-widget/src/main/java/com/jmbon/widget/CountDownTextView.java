...
/**
 * 倒计时文本
 * Created by lengyue on 2017/10/31 0031 23:01.
 */
public class CountDownTextView extends AppCompatTextView implements LifecycleObserver, View.OnClickListener {
    ...
    private OnCountDownCancelListener mOnCountDownCancelListener;
     ...
     * @param firstText 文本
     */
    public CountDownTextView setFirstText(String firstText) {
        firstText = firstText;
        setText(firstText);
        return this;
    }
    ...
    public void cancel() {
        ...
        mClickable = true;
        setText(mNormalText);
        if (mOnCountDownCancelListener!= null)
            mOnCountDownCancelListener.onCancel();
    }
    ...
    public CountDownTextView setOnCountDownCancelListener(OnCountDownCancelListener onCountDownFinishListener) {
        mOnCountDownCancelListener = onCountDownFinishListener;
        return this;
    }
