...
//    private ScrollView scrollView;
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(ColorUtils.getColor(R.color.color_currency));
            } else {
                itemView.setTextColor(ColorUtils.getColor(R.color.color_BFBFBF));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            ...
            int[] colors =
                    new int[]{
                            Color.parseColor("#005384FF"),
                            Color.parseColor("#FF5384FF"),
                    };

            float[] alphs = new float[2];
            alphs[0] = 0f;
            alphs[1] = 1.0f;
            LinearGradient linearGradient = new LinearGradient(
                    0f, 0f, viewWidth / 2, 0, colors
                    , alphs, Shader.TileMode.MIRROR);
    ...
    public void setSeletionNoAmimal(int position) {
        final int p = position;
        selectedIndex = p + offset;
        this.post(new Runnable() {
            @Override
