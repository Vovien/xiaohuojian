package com.jmbon.widget.interpolator;
...
public class FastSlowEaseCubicInterpolator implements Interpolator {
    ...
    public FastSlowEaseCubicInterpolator() {
        mControlPoint1.x = 0.0f;

        mControlPoint1.y = 0.63f;

        mControlPoint2.x = 0.37f;

        mControlPoint2.y = 1.0f;
    }
    ...
    public FastSlowEaseCubicInterpolator(float x1, float y1, float x2, float y2) {
