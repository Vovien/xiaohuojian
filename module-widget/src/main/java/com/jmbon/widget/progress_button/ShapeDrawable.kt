...
class ShapeDrawable {
    ...
    fun setShapeType(shapeType: Int): ShapeDrawable {
        this.shapeType = shapeType
        return this
    }

    fun setShapeSolidColor(color: Int): ShapeDrawable {
        this.solidColor = color
        return this
    }

    fun setShapeCornersRadius(radius: Float): ShapeDrawable {
        this.cornersRadius = radius
        return this
    }

    fun setShapeCornersTopLeftRadius(radius: Float): ShapeDrawable {
        this.cornersTopLeftRadius = radius
        return this
    }

    fun setShapeCornersTopRightRadius(radius: Float): ShapeDrawable {
        this.cornersTopRightRadius = radius
        return this
    }

    fun setShapeCornersBottomRightRadius(radius: Float): ShapeDrawable {
        this.cornersBottomRightRadius = radius
        return this
    }

    fun setShapeCornersBottomLeftRadius(radius: Float): ShapeDrawable {
        this.cornersBottomLeftRadius = radius
        return this
    }

    fun setShapeStrokeWidth(strokeWidth: Int): ShapeDrawable {
        this.strokeWidth = strokeWidth
        return this
    }

    fun setShapeStrokeColor(strokeColor: Int): ShapeDrawable {
        this.strokeColor = strokeColor
        return this
    }

    fun setShapeStrokeDisableColor(strokeDisableColor: Int): ShapeDrawable {
        this.strokeDisableColor = strokeDisableColor
        return this
    }

    fun setShapeStrokePressedColor(strokePressedColor: Int): ShapeDrawable {
        this.strokePressedColor = strokePressedColor
        return this
    }

    fun setShapeStrokeDashWidth(strokeDashWidth: Float): ShapeDrawable {
        this.strokeDashWidth = strokeDashWidth
        return this
    }

    fun setShapeStrokeDashGap(strokeDashGap: Float): ShapeDrawable {
        this.strokeDashGap = strokeDashGap
        return this
    }

    fun setShapeUseSelector(useSelector: Boolean): ShapeDrawable {
        this.useSelector = useSelector
        return this
    }

    fun setShapeSelectorPressedColor(color: Int): ShapeDrawable {
        this.selectorPressedColor = color
        return this
    }

    fun setShapeSelectorNormalColor(color: Int): ShapeDrawable {
    ...
    fun setShapeSelectorDisableColor(color: Int): ShapeDrawable {
        this.selectorDisableColor = color
        return this
    }


    fun setShapeSizeWidth(sizeWidth: Int): ShapeDrawable {
        this.sizeWidth = sizeWidth
        return this
    }

    fun setShapeSizeHeight(sizeHeight: Int): ShapeDrawable {
        this.sizeHeight = sizeHeight
        return this
    }

    fun setShapeGradientAngle(gradientAngle: Int): ShapeDrawable {
        this.gradientAngle = gradientAngle
        return this
    }

    fun setShapeGradientCenterX(gradientCenterX: Int): ShapeDrawable {
        this.gradientCenterX = gradientCenterX
        return this
    }

    fun setShapeGradientCenterY(gradientCenterY: Int): ShapeDrawable {
        this.gradientCenterY = gradientCenterY
        return this
    }

    fun setShapeGradientGradientRadius(gradientGradientRadius: Int): ShapeDrawable {
        this.gradientGradientRadius = gradientGradientRadius
        return this
    }

    fun setShapeGradientStartColor(gradientStartColor: Int): ShapeDrawable {
        this.gradientStartColor = gradientStartColor
        return this
    }

    fun setShapeGradientCenterColor(gradientCenterColor: Int): ShapeDrawable {
        this.gradientCenterColor = gradientCenterColor
        return this
    }

    fun setShapeGradientEndColor(gradientEndColor: Int): ShapeDrawable {
        this.gradientEndColor = gradientEndColor
        return this
    }

    fun setShapeGradientType(gradientType: Int): ShapeDrawable {
        this.gradientType = gradientType
        return this
    }

    fun setShapeGradientUseLevel(gradientUseLevel: Boolean): ShapeDrawable {
    ...
    fun init(targetView: View, attributeSetData: AttributeSetData) {
        ...
        setShapeGradientCenterX(attributeSetData.gradientCenterX.toInt())
        setShapeGradientCenterY(attributeSetData.gradientCenterY.toInt())
