...
import com.jmbon.widget.tablayout.utils.FragmentChangeManager;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectSize = ta.getDimension(R.styleable.CommonTabLayout_tl_textSelectSize, Color.parseColor("#ffffff"));
        mTextUnSelectSize = ta.getDimension(R.styleable.CommonTabLayout_tl_textUnSelectSize, Color.parseColor("#AAffffff"));
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void calcIndicatorRects() {
        View currentTabView = mTabsContainer.getChildAt(this.mCurrentTab);
        float left = currentTabView.getLeft();
        float right = currentTabView.getRight();
    ...
    public void setTextUnselectSize(int textUnselectSize) {
