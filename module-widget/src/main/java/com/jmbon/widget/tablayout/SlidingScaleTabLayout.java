...
import com.jmbon.widget.tablayout.transformer.ColorTransformer;
import com.jmbon.widget.tablayout.transformer.ExtendTransformer;
import com.jmbon.widget.tablayout.transformer.ITabScaleTransformer;
import com.jmbon.widget.tablayout.transformer.IViewPagerTransformer;
import com.jmbon.widget.tablayout.transformer.TabScaleTransformer;
...
public class SlidingScaleTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private ITabScaleTransformer iTabColorTransformer;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        arrayList.add(Color.parseColor("#262626"));
        arrayList.add(Color.parseColor("#303030"));
        arrayList.add(Color.parseColor("#3a3a3a"));
        arrayList.add(Color.parseColor("#444444"));
        arrayList.add(Color.parseColor("#4e4e4e"));
        arrayList.add(Color.parseColor("#575757"));
        arrayList.add(Color.parseColor("#616161"));
        arrayList.add(Color.parseColor("#6b6b6b"));
        arrayList.add(Color.parseColor("#757575"));
        arrayList.add(Color.parseColor("#7f7f7f"));
        iTabColorTransformer = new ColorTransformer(this, arrayList);
    }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                // 被选中设置为粗体
                    ...
                    tv_tab_title.setTypeface(i == mCurrentTab ? Typeface.defaultFromStyle(Typeface.BOLD) : Typeface.defaultFromStyle(Typeface.NORMAL));
...
//        Log.i("onPageScrolled", "mCurrentTab：" + mCurrentTab + " positionOffset:" + positionOffset);
        ...
        iTabColorTransformer.onPageScrolled(position, positionOffset, positionOffsetPixels);
    }
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTypeface(Typeface.defaultFromStyle(i == mCurrentTab ? Typeface.BOLD : Typeface.NORMAL));
                // 设置选中状态
                ...
                // 被选中设置为粗体
                    ...
                    tab_title.setTypeface(Typeface.defaultFromStyle(mTextBold == TEXT_BOLD_WHEN_SELECT ? Typeface.BOLD : Typeface.NORMAL));
...
//        }
        ...
        return tabView.findViewById(R.id.tv_tab_title_dmg);
    }
